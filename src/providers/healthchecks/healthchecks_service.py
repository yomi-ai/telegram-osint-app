...
class HealthchecksService:
    ...
    def __init__(self, config_service: ConfigService, logger: Logger):
        ...
        self.healthchecks_ping_url = (
            f"https://hc-ping.com/{self.healthchecks_ping_key}/telegram-osint-app"
        )
